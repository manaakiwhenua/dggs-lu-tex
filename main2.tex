...
In this paper we also perform a benchmarking exercise to compare the performance of overlay and geographic object classification when using a \ac{DGGS} against the alternate performance of equivalent vector- and raster-oriented workflows.
